package com.lonnie.common.util;
...
//        sendEmail(context, addresses, subject, body, file, null);
//    }

//    public static void sendEmail(Context context, String[] addresses, String subject, String body, @Nullable File file, @Nullable String chooseTitle) {
...
//    }
    ...
    public static void shareToOtherApps(Context context, String text, @StringRes int customTitleRes) {
        ...
        if (!resolveInfoList.isEmpty()) {
            ...
            Log.e(TAG, "No other Apps found to share");
        }
    }
...
//                customTabsIntent,
//                Uri.parse(url),
//                (act, uri) -> com.glip.uikit.utils.ExternalAppUtil.go2App(act, url)
//        );
//    }
}
